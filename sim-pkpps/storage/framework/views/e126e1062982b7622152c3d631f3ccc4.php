...
<?php $__env->startSection('title', 'Profil Santri'); ?>
...
<div class="content-box">
    ...
    <div class="detail-header">
        <div style="display: flex; align-items: center; gap: 20px;">
            ...
            <div>
                ...
                <p style="margin: 5px 0 0 0; color: var(--text-light);">
                    <i class="fas fa-id-card"></i> <?php echo e($santri->id_santri); ?>
        ...
        <div>
            <a href="<?php echo e(route('santri.profil.edit')); ?>" class="btn btn-primary">
    ...
    <div class="detail-section">
        ...
        <table class="detail-table">
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-primary badge-lg">
                        ...
                        <?php echo e($santri->kelas_lengkap); ?>
            ...
            <tr>
                ...
                <td><?php echo $santri->status_badge; ?></td>
            </tr>
            <tr>
                <th><i class="fas fa-calendar-plus"></i> Terdaftar Sejak</th>
                <td><?php echo e($santri->created_at->format('d F Y')); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="detail-section">
        ...
        <table class="detail-table">
            ...
            <tr>
                ...
                <td><?php echo e($santri->daerah_asal ?? '-'); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <?php if($santri->nomor_hp_ortu): ?>
                        <a href="tel:<?php echo e($santri->nomor_hp_ortu); ?>" class="link-primary">
                            <i class="fas fa-phone-alt"></i> <?php echo e($santri->nomor_hp_ortu); ?>
