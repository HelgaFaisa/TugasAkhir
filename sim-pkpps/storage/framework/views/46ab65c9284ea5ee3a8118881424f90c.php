            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="<?php echo e(route('admin.kategori-kegiatan.destroy', $kategori)); ?>" method="POST" style="display: inline-block;" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                            <?php echo csrf_field(); ?>
