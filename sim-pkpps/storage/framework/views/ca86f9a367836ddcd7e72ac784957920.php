...
<div class="form-container">
    <form action="<?php echo e(route('admin.capaian.store')); ?>" method="POST" id="formCapaian">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                ...
                <?php $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($santri->id_santri); ?>" 
                            ...
                            <?php echo e(old('id_santri', $selectedSantri?->id_santri) == $santri->id_santri ? 'selected' : ''); ?>>
                        <?php echo e($santri->nama_lengkap); ?> (<?php echo e($santri->nis); ?>) - Kelas: <?php echo e($santri->kelas); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div class="form-group">
                ...
                <select name="id_materi" id="id_materi" class="form-control <?php $__errorArgs = ['id_materi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="id_semester" id="id_semester" class="form-control <?php $__errorArgs = ['id_semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($semester->id_semester); ?>" 
                                <?php echo e(old('id_semester', $semesterAktif?->id_semester) == $semester->id_semester ? 'selected' : ''); ?>>
                            <?php echo e($semester->nama_semester); ?> 
                            <?php if($semester->is_active): ?> <strong>(Aktif)</strong> <?php endif; ?>
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['id_semester'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div id="metode1" class="metode-input">
                    <div class="form-group">
                        ...
                        <input type="text" name="halaman_selesai" id="halaman_selesai" 
                               class="form-control <?php $__errorArgs = ['halaman_selesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               ...
                               value="<?php echo e(old('halaman_selesai')); ?>">
                        ...
                        <?php $__errorArgs = ['halaman_selesai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                      rows="3" placeholder="Catatan tambahan tentang capaian ini..."><?php echo e(old('catatan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal_input" class="form-control <?php $__errorArgs = ['tanggal_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                   value="<?php echo e(old('tanggal_input', date('Y-m-d'))); ?>" required>
            <?php $__errorArgs = ['tanggal_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
function loadMateriForSantri(idSantri, kelasSantri) {
    ...
    fetch('<?php echo e(route("admin.capaian.ajax.get-materi")); ?>', {
        method: 'POST',
        headers: {
...
function checkExistingCapaian() {
    ...
    fetch('<?php echo e(route("admin.capaian.ajax.get-detail-materi")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TugasAkhir\sim-pkpps\resources\views/admin/capaian/create.blade.php ENDPATH**/ ?>