...
<?php $__env->startSection('title', $pembinaan->judul); ?>
    ...
    <div>
                ...
                <div>
                    <div style="opacity: 0.8; font-size: 0.82em; margin-bottom: 3px;">
                        <span class="badge" style="background: rgba(255,255,255,0.25); color: white; font-size: 0.9em;">
                            <?php echo e($pembinaan->id_pembinaan); ?>

                        </span>
                    </div>
                    <h3 style="margin: 0; font-size: 1.1em; line-height: 1.3;"><?php echo e($pembinaan->judul); ?></h3>
                </div>
            </div>
            <a href="<?php echo e(route('santri.pembinaan.index')); ?>"
        ...
        <div class="content-box" style="border-radius: 0 0 var(--border-radius) var(--border-radius); border-top: none; margin-top: 0;">
            <div style="color: var(--text-light); font-size: 0.82em; margin-bottom: 18px;
                ...
                <span><i class="fas fa-clock"></i> Terakhir diperbarui: <?php echo e($pembinaan->updated_at->isoFormat('D MMMM YYYY')); ?></span>
            </div>

            
            <div class="pembinaan-content" style="line-height: 1.85; font-size: 0.97em; color: var(--text-color);">
                <?php echo $pembinaan->konten; ?>
            ...
            <div style="margin-top: 28px; padding-top: 18px; border-top: 1px solid #eee;
                ...
                <?php if($prev): ?>
                <a href="<?php echo e(route('santri.pembinaan.show', $prev->id_pembinaan)); ?>"
                ...
                <?php if($next): ?>
                <a href="<?php echo e(route('santri.pembinaan.show', $next->id_pembinaan)); ?>"
            ...
            <div style="max-height: 400px; overflow-y: auto;">
                ...
                <a href="<?php echo e(route('santri.pembinaan.show', $item->id_pembinaan)); ?>"
                   style="display: flex; align-items: center; gap: 10px; padding: 11px 16px;
                          ...
                          background: <?php echo e($item->id_pembinaan === $pembinaan->id_pembinaan ? 'var(--primary-light)' : 'white'); ?>;
                          color: <?php echo e($item->id_pembinaan === $pembinaan->id_pembinaan ? 'var(--primary-color)' : 'var(--text-color)'); ?>;
                          transition: background 0.15s;"
                   onmouseover="if(this.style.background !== 'var(--primary-light)') this.style.background='#f8f9fa'"
                   onmouseout="if('<?php echo e($item->id_pembinaan); ?>' !== '<?php echo e($pembinaan->id_pembinaan); ?>') this.style.background='white'">
                    <span style="background: <?php echo e($item->id_pembinaan === $pembinaan->id_pembinaan ? 'var(--primary-color)' : '#e9ecef'); ?>;
                                 color: <?php echo e($item->id_pembinaan === $pembinaan->id_pembinaan ? 'white' : 'var(--text-light)'); ?>;
                    ...
                    <span style="font-size: 0.88em; line-height: 1.3;
                                 ...
                                 font-weight: <?php echo e($item->id_pembinaan === $pembinaan->id_pembinaan ? '600' : 'normal'); ?>;">
                        <?php echo e($item->judul); ?>

                    </span>
                    <?php if($item->id_pembinaan === $pembinaan->id_pembinaan): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TugasAkhir\sim-pkpps\resources\views/santri/pembinaan/show.blade.php ENDPATH**/ ?>