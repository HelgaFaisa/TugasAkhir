                    ...
                    <tr>
                        <td style="padding: 32px;">
                            <p style="margin: 0 0 16px; color: #2A4235; font-size: 15px;">
                                Assalamu'alaikum <strong><?php echo e($nama); ?></strong>,
                            </p>
                    ...
                    <tr>
                        <td style="background: #f8fdfb; padding: 18px 32px; text-align: center; border-top: 1px solid #eee;">
                            <p style="margin: 0; color: #aaa; font-size: 11px;">
                                &copy; <?php echo e(date('Y')); ?> SIM PKPPS &mdash; Email ini dikirim secara otomatis
                            </p>
                        </td>
                    </tr>
                </table>
...
<?php /**PATH C:\xampp\htdocs\TugasAkhir\sim-pkpps\resources\views/emails/otp.blade.php ENDPATH**/ ?>