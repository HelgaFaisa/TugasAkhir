...
<table class="main">
    ...
    <tr><td class="td-nama">
        <div class="nama-box">
            <span class="nama-text"><?php echo e($namaSantri); ?></span>
        </div>
    </td></tr>
        ...
        <table class="info-t">
            <tr>
                <td class="ic-nis">
                    ...
                    <span class="val"><?php echo e($nis); ?></span>
                </td>
                <td class="ic-kelas">
                    <span class="lbl">Kelas</span>
                    <span class="val-sm"><?php echo e($kelasNama); ?></span>
                </td>
                <td class="ic-rfid">
                    <span class="lbl">UID RFID</span>
                    <span class="val-rfid"><?php echo e($uid); ?></span>
                </td>
            </tr>
        </table>
    </td></tr>
