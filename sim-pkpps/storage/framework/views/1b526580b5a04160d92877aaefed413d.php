...
<div class="page-header">
    ...
    <a href="<?php echo e(route('admin.laporan-kegiatan.index')); ?>" class="btn btn-secondary">
...
<div class="content-box" style="margin-bottom: 14px;">
    <div style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:12px;">
        <div>
            <h3 style="margin:0 0 6px; color:var(--primary-dark);"><?php echo e($kegiatan->nama_kegiatan); ?></h3>
            <p style="margin:0; font-size:0.85rem; color:var(--text-light);">
                ...
                <i class="fas fa-clock" style="margin-left:12px;"></i> <?php echo e($kegiatan->waktu_lengkap); ?>

                <i class="fas fa-calendar" style="margin-left:12px;"></i> <?php echo e($kegiatan->hari); ?>

            </p>
            <?php if(!$kegiatan->isForAllClasses()): ?>
                <p style="margin:4px 0 0; font-size:0.82rem;">
                    <i class="fas fa-school"></i> Kelas:
                    <?php $__currentLoopData = $kegiatan->kelasKegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="badge badge-success"><?php echo e($kk->nama_kelas); ?></span>
        ...
        <div style="text-align:right;">
            <p style="margin:0; font-size:0.82rem; color:var(--text-light);">Periode: <strong><?php echo e($periodeLabel); ?></strong></p>
        </div>
    </div>
</div>
...
<div class="content-box" style="margin-bottom: 14px;">
    ...
    <?php $statsPersen = $stats->persen ?? 0; ?>
    <div class="progress-bar-lg">
        <div class="fill" style="width:<?php echo e($statsPersen); ?>%; background:<?php echo e($statsPersen >= 85 ? '#10B981' : ($statsPersen >= 70 ? '#FBBF24' : '#EF4444')); ?>;">
            <?php echo e($statsPersen); ?>%
        </div>
    </div>
</div>
...
<div class="two-col">
    ...
    <div class="chart-box">
        ...
        <?php if($punctuality && $punctuality->total > 0): ?>
            <div style="height:250px;">
                <canvas id="punctualityChart"></canvas>
            </div>
            <div style="margin-top:12px; font-size:0.82rem; color:var(--text-light); text-align:center;">
                <?php echo e($punctuality->tepat_waktu ?? 0); ?> tepat waktu, <?php echo e($punctuality->terlambat ?? 0); ?> terlambat dari <?php echo e($punctuality->total); ?> total
            </div>
        <?php else: ?>
...
<?php if(!empty($breakdownPerKelas) && count($breakdownPerKelas) > 0): ?>
<div class="chart-box">
    ...
    <table class="data-table" style="font-size:0.85rem;">
        ...
        <tbody>
            <?php $__currentLoopData = $breakdownPerKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="<?php echo e($bk['persen'] < 70 ? 'background:#FEF2F2;' : ''); ?>">
                    <td><strong><?php echo e($bk['kelas']); ?></strong></td>
                    <td class="text-center"><?php echo e($bk['total']); ?></td>
                    <td class="text-center"><span class="badge badge-success"><?php echo e($bk['hadir']); ?></span></td>
                    <td class="text-center">
                        <div class="progress-inline" style="justify-content:center;">
                            <div class="progress-bar-mini"><div class="fill" style="width:<?php echo e($bk['persen']); ?>%; background:<?php echo e($bk['persen'] >= 85 ? '#10B981' : ($bk['persen'] >= 70 ? '#FBBF24' : '#EF4444')); ?>;"></div></div>
                            <strong><?php echo e($bk['persen']); ?>%</strong>
                        </div>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php if($santriTidakPernahHadir && $santriTidakPernahHadir->count() > 0): ?>
<div class="chart-box">
    <h4><i class="fas fa-user-times" style="color:#EF4444;"></i> Santri Tidak Pernah Hadir</h4>
    <div style="display:flex; flex-wrap:wrap; gap:8px;">
        <?php $__currentLoopData = $santriTidakPernahHadir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('admin.laporan-kegiatan.detail-santri', $sth->id_santri)); ?>" class="badge badge-danger" style="padding:6px 12px; font-size:0.82rem; text-decoration:none;">
                <?php echo e($sth->santri->nama_lengkap ?? $sth->id_santri); ?>
...
<div class="chart-box">
    ...
    <?php $__currentLoopData = $insights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="insight-box i-<?php echo e($insight['type']); ?>">
            <i class="<?php echo e($insight['icon']); ?>"></i>
...
<div class="content-box" style="display:flex; gap:8px; flex-wrap:wrap;">
    <a href="<?php echo e(route('admin.absensi-kegiatan.rekap', $kegiatan->kegiatan_id)); ?>" class="btn btn-info">
    ...
    <a href="<?php echo e(route('admin.laporan-kegiatan.index')); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
</div>
...
new Chart(document.getElementById('punctualityChart'), {
    ...
    data: {
        ...
        datasets: [{
            data: [<?php echo e($punctuality->tepat_waktu ?? 0); ?>, <?php echo e($punctuality->terlambat ?? 0); ?>],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TugasAkhir\sim-pkpps\resources\views/admin/kegiatan/laporan/analisis-kegiatan.blade.php ENDPATH**/ ?>