...
<!-- DATA MASTER -->
<li class="menu-toggle <?php echo e(Request::routeIs('admin.santri.*') || Request::routeIs('admin.users.*') ? 'active' : ''); ?>">
...
<li class="menu-toggle <?php echo e(Request::routeIs('admin.materi.*') || Request::routeIs('admin.semester.*') || Request::routeIs('admin.capaian.*') ? 'active' : ''); ?>">
    ...
    <ul class="submenu">
        ...
        <li>
            <a href="<?php echo e(route('admin.materi.index')); ?>" class="<?php echo e(Request::routeIs('admin.materi.*') ? 'active' : ''); ?>">
                <i class="fas fa-book"></i><span>Master Materi</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('admin.semester.index')); ?>" class="<?php echo e(Request::routeIs('admin.semester.*') ? 'active' : ''); ?>">
        ...
        <li>
            <a href="<?php echo e(route('admin.capaian.rekap-kelas')); ?>" class="<?php echo e(Request::routeIs('admin.capaian.rekap-kelas') ? 'active' : ''); ?>">
...
<!-- KEGIATAN SANTRI -->
<li class="menu-toggle <?php echo e(Request::routeIs('admin.kategori-kegiatan.*') || Request::routeIs('admin.kegiatan.*') || Request::routeIs('admin.absensi-kegiatan.*') || Request::routeIs('admin.kartu-rfid.*') || Request::routeIs('admin.riwayat-kegiatan.*') ? 'active' : ''); ?>">
    <a href="javascript:void(0)" class="menu-parent">
    ...
    <ul class="submenu">
        <li>
            <a href="<?php echo e(route('admin.kategori-kegiatan.index')); ?>" 
               class="<?php echo e(Request::routeIs('admin.kategori-kegiatan.*') ? 'active' : ''); ?>">
                <i class="fas fa-list-alt"></i><span>Kategori Kegiatan</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('admin.kegiatan.index')); ?>" 
               class="<?php echo e(Request::routeIs('admin.kegiatan.*') && !Request::routeIs('admin.riwayat-kegiatan.*') ? 'active' : ''); ?>">
                <i class="fas fa-calendar-check"></i><span>Jadwal Kegiatan</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('admin.absensi-kegiatan.index')); ?>" 
               class="<?php echo e(Request::routeIs('admin.absensi-kegiatan.*') ? 'active' : ''); ?>">
