...
<div class="content-box">
    ...
    <div class="detail-section">
        ...
        <table class="detail-table">
            ...
            <tr>
                ...
                <td><?php echo e($transaksi->tanggal_transaksi->isoFormat('dddd, D MMMM YYYY')); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <span style="font-size: 1.4rem; font-weight: 700; color: <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? '#6FBA9D' : '#FF8B94'); ?>;">
            ...
            <tr>
                ...
                <td><?php echo e($transaksi->created_at->format('d/m/Y H:i:s')); ?> WIB</td>
            </tr>
        </table>
    </div>
    ...
    <div class="detail-section">
        ...
        <table class="detail-table">
            <tr>
                ...
                <td><strong>Rp <?php echo e(number_format($transaksi->saldo_sebelum, 0, ',', '.')); ?></strong></td>
            </tr>
            <tr>
                <th>
                    <i class="fas fa-<?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? 'plus' : 'minus'); ?>-circle"></i>
                    <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? 'Pemasukan' : 'Pengeluaran'); ?>

                </th>
                <td style="color: <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? '#6FBA9D' : '#FF8B94'); ?>; font-weight: 700;">
                    <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? '+' : '-'); ?> <?php echo e($transaksi->nominal_format); ?>
    ...
    <div class="detail-section">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
            <div style="background: linear-gradient(135deg, #E8F7F2, #D4F1E3); padding: 16px; border-radius: 12px; text-align: center;">
                ...
                <p style="font-size: 1.4rem; font-weight: 700; color: #6FBA9D; margin: 0;">
                    <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? $transaksi->nominal_format : 'Rp 0'); ?>
            ...
            <div style="background: linear-gradient(135deg, #FFE8EA, #FFD5D8); padding: 16px; border-radius: 12px; text-align: center;">
                ...
                <p style="font-size: 1.4rem; font-weight: 700; color: #FF8B94; margin: 0;">
                    <?php echo e($transaksi->jenis_transaksi === 'pengeluaran' ? $transaksi->nominal_format : 'Rp 0'); ?>
        ...
        <div style="background: white; padding: 20px; border-radius: 12px; border: 2px solid #E8F7F2;">
            ...
            <div style="height: 36px; background: #e0e0e0; border-radius: 18px; overflow: hidden; margin-bottom: 16px;">
                <div style="height: 100%; width: <?php echo e(max($pctSebelum, 3)); ?>%; background: linear-gradient(90deg, var(--primary-color), #4a9e7f); border-radius: 18px;"></div>
            </div>

            <div style="text-align: center; margin-bottom: 16px;">
                <i class="fas fa-arrow-<?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? 'up' : 'down'); ?>"
                   style="font-size: 1.4rem; color: <?php echo e($colorSesudah); ?>;"></i>
                <p style="margin: 4px 0 0 0; font-size: 0.85rem; color: var(--text-light);">
                    Saldo <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? 'bertambah' : 'berkurang'); ?>

                    <strong style="color: <?php echo e($colorSesudah); ?>;"><?php echo e($transaksi->nominal_format); ?></strong>
                </p>
            </div>

            <div style="height: 36px; background: #e0e0e0; border-radius: 18px; overflow: hidden; margin-bottom: 6px;">
                <div style="height: 100%; width: <?php echo e(max($pctSesudah, 3)); ?>%; background: linear-gradient(90deg, <?php echo e($colorSesudah); ?>, <?php echo e($transaksi->jenis_transaksi === 'pemasukan' ? '#4CAF50' : '#e07080'); ?>); border-radius: 18px;"></div>
            </div>
            <div style="display: flex; justify-content: space-between;">
                <span style="font-size: 0.9rem; color: var(--text-light);">Saldo Sesudah</span>
                <strong style="color: <?php echo e($colorSesudah); ?>; font-size: 1.05rem;">
                    Rp <?php echo e(number_format($transaksi->saldo_sesudah, 0, ',', '.')); ?>
    ...
    <div style="margin-top: 22px; text-align: center;">
        <a href="<?php echo e(route('santri.uang-saku.index')); ?>" class="btn btn-primary">
